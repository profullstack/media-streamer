-- Fix search_all_torrents function type mismatches
-- bt_torrents.infohash is varchar(40), bt_torrents.content_type is varchar(50)
-- Function declares TEXT - need explicit casts
