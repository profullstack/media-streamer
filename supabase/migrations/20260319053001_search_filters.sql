-- Add filter parameters to search_all_torrents:
...
BEGIN
    ...
    dht_candidates AS (
        ...
        WHERE to_tsvector('simple', t.name) @@ longest_tsq
          -- Apply size and date filters early for efficiency
    ...
    dht_results AS (
        ...
        -- Apply seeders/leechers filters after joining torrent sources
