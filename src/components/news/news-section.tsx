      ...
      {selectedArticle ? <div
        ...
        >
          ...
          <div className="relative w-full max-w-4xl h-[75vh] bg-gray-900 rounded-lg overflow-hidden flex flex-col z-10">
            ...
            {showSummary && summary ? (
              /* AI Summary View */
              <div ref={contentRef} className="flex-1 min-h-0 overflow-y-auto p-6 bg-gray-800 relative">
                {/* Summary Header */}
                <div className="mb-6">
              ...
              /* Iframe View */
              <div ref={contentRef} className="flex-1 min-h-0 bg-white relative overflow-auto">
                <iframe
