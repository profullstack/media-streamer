...
// Mock next/image
vi.mock('next/image', () => ({
  default: ({ src, alt, priority: _priority, ...props }: { src: string; alt: string; priority?: boolean; [key: string]: unknown }) => (
...
describe('Sidebar Navigation', () => {
  ...
  describe('Navigation Item Count', () => {
    it('should show all nav items when logged out (all items visible, auth-required redirect to login)', () => {
      ...
      // Logo link + 11 main nav items + 2 account items + 4 external sites = 18
      // Home, Search, Trending, My Library, Torrents, Find Torrents, News, Podcasts, Live TV, Live Radio, Watch Party = 11 main
